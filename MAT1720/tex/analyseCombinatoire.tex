...
\dfn{Arrangement}{Dans un ensemble E de $n$~éléments, sous-ensemble ordonné de $k$~éléments de E pris \emph{sans répétition}}
...
\dfn{Coefficients multinomiaux}{$\binom{n}{n_1,n_2,\dots,n_k}$}
