\chapter{Analyse combinatoire}\label{chap:analyseCombinatoire}\cours{1}
\section{Introduction}\ross{14}{3}{1}
\dfn{Analyse combinatoire}{Théorie mathématique du dénombrement}

\section[Principe fondamental de dénombrement (Principe de multiplication)]{Principe fondamental de dénombrement\\(Principe de multiplication)}\ross{15}{3}{1}
...
\section{Permutations}\ross{17}{5}{1}
\subsection{Permutations d’objets discernables}
\dfn{Permutation}{Arrangement de $n$ objets considérés en même temps et pris dans un ordre donné}
...
\dfn{Arrangement}{Dans un ensemble E de $n$~éléments, sous-ensemble ordonné de $r$~éléments de E pris \emph{sans répétition}}
...
\section{Combinaisons}\index{Combinaison}\ross{20}{7}{1}

L’ordre n’est pas important.

\dfn{Combinaison}{Dans un ensemble E comprenant n éléments, tout sous-ensemble de E comprenant k éléments sans répétitions}
...
\section{Théorème du binôme}\label{sec:theoremeBinome}\index{Théorème du binôme}\cours{2}\ross{23}{9}{1}
